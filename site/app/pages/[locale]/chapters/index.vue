<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    ...
    <p class="mb-8" style="color: var(--color-muted);">
      {{ availableCount }} chapters available out of {{ localChapters.length }} total.
    </p>
    ...
    <div class="space-y-3">
      <component
        ...
        :key="chapter.slug"
        v-bind="chapter.available ? { to: `/${locale}/chapters/${chapter.slug}` } : {}"
...
if (locale.value === 'it') {
  await navigateTo(`/it/capitoli`, { replace: true })
}

const localChapters = computed(() => getChapters('en'))
...
useSeoMeta({
  title: 'Chapters — Phaser 4 Game Dev',
  description: 'All chapters of the Phaser 4 Game Dev course in English.',
})
</script>
